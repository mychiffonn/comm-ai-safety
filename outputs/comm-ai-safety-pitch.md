...
theme: default
style: |
  section { font-family: Arial, sans-serif; color: #101828; padding: 56px 68px; }
  h1 { color: #102A43; font-size: 1.55em; }
  h2 { color: #0B7285; font-size: 1.05em; }
  strong { color: #0B7285; }
  table { font-size: 0.78em; }
  blockquote { color: #344054; border-left: 8px solid #0B7285; }
---
...
- github.com/chiffonng/comm-ai-safety
